...
type Storage struct {
	...
	Driver Storage_Driver `protobuf:"varint,1,opt,name=driver,proto3,enum=tech_school.pc_book.Storage_Driver" json:"driver,omitempty"`
...
var file_storage_message_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x13, 0x74, 0x65, 0x63, 0x68, 0x5f, 0x73, 0x63,
	0x68, 0x6f, 0x6f, 0x6c, 0x2e, 0x70, 0x63, 0x5f, 0x62, 0x6f, 0x6f, 0x6b, 0x1a, 0x14, 0x6d, 0x65,
	...
	0x65, 0x6d, 0x6f, 0x72, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x74, 0x65,
	0x63, 0x68, 0x5f, 0x73, 0x63, 0x68, 0x6f, 0x6f, 0x6c, 0x2e, 0x70, 0x63, 0x5f, 0x62, 0x6f, 0x6f,
	...
	0x12, 0x07, 0x0a, 0x03, 0x53, 0x53, 0x44, 0x10, 0x02, 0x42, 0x07, 0x5a, 0x05, 0x2e, 0x2f, 0x3b,
...
var file_storage_message_proto_goTypes = []interface{}{
	(Storage_Driver)(0), // 0: tech_school.pc_book.Storage.Driver
	(*Storage)(nil),     // 1: tech_school.pc_book.Storage
	(*Memory)(nil),      // 2: tech_school.pc_book.Memory
}
var file_storage_message_proto_depIdxs = []int32{
	0, // 0: tech_school.pc_book.Storage.driver:type_name -> tech_school.pc_book.Storage.Driver
	2, // 1: tech_school.pc_book.Storage.memory:type_name -> tech_school.pc_book.Memory
