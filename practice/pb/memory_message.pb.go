...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=tech_school.pc_book.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x6f, 0x6f, 0x6c, 0x2e, 0x70, 0x63, 0x5f, 0x62, 0x6f, 0x6f, 0x6b, 0x22, 0xb4, 0x01, 0x0a, 0x06,
	...
	0x75, 0x6e, 0x69, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x20, 0x2e, 0x74, 0x65, 0x63,
	...
	0x10, 0x06, 0x42, 0x07, 0x5a, 0x05, 0x2e, 0x2f, 0x3b, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_memory_message_proto_goTypes = []interface{}{
	(Memory_Unit)(0), // 0: tech_school.pc_book.Memory.Unit
	(*Memory)(nil),   // 1: tech_school.pc_book.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: tech_school.pc_book.Memory.unit:type_name -> tech_school.pc_book.Memory.Unit
