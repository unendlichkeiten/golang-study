...
var file_laptop_service_proto_rawDesc = []byte{
	...
	0x6f, 0x6f, 0x6c, 0x2e, 0x70, 0x63, 0x5f, 0x62, 0x6f, 0x6f, 0x6b, 0x1a, 0x14, 0x6c, 0x61, 0x70,
	...
	0x6f, 0x70, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x74, 0x65, 0x63, 0x68, 0x5f,
	0x73, 0x63, 0x68, 0x6f, 0x6f, 0x6c, 0x2e, 0x70, 0x63, 0x5f, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x4c,
	...
	0x4c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x12, 0x28, 0x2e, 0x74, 0x65, 0x63, 0x68, 0x5f, 0x73, 0x63,
	0x68, 0x6f, 0x6f, 0x6c, 0x2e, 0x70, 0x63, 0x5f, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x43, 0x72, 0x65,
	0x61, 0x74, 0x65, 0x4c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x29, 0x2e, 0x74, 0x65, 0x63, 0x68, 0x5f, 0x73, 0x63, 0x68, 0x6f, 0x6f, 0x6c, 0x2e, 0x70,
...
var file_laptop_service_proto_goTypes = []interface{}{
	(*CreateLaptopRequest)(nil),  // 0: tech_school.pc_book.CreateLaptopRequest
	(*CreateLaptopResponse)(nil), // 1: tech_school.pc_book.CreateLaptopResponse
	(*Laptop)(nil),               // 2: tech_school.pc_book.Laptop
}
var file_laptop_service_proto_depIdxs = []int32{
	2, // 0: tech_school.pc_book.CreateLaptopRequest.laptop:type_name -> tech_school.pc_book.Laptop
	0, // 1: tech_school.pc_book.LaptopService.CreateLaptop:input_type -> tech_school.pc_book.CreateLaptopRequest
	1, // 2: tech_school.pc_book.LaptopService.CreateLaptop:output_type -> tech_school.pc_book.CreateLaptopResponse
...
func (c *laptopServiceClient) CreateLaptop(ctx context.Context, in *CreateLaptopRequest, opts ...grpc.CallOption) (*CreateLaptopResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tech_school.pc_book.LaptopService/CreateLaptop", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _LaptopService_CreateLaptop_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tech_school.pc_book.LaptopService/CreateLaptop",
	}
...
var _LaptopService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "tech_school.pc_book.LaptopService",
